...
- **Preserves** paragraphs, runs, tables, numbering, and most formatting _inside the body_.
...
- If either document contains tracked changes or comments, merge first _then_ run the tracked-changes / comments tasks.
