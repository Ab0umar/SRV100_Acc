...
- `scripts/fields_materialize.py` — materialize `SEQ/REF` _display text_ so headless renders show the correct numbers
...
- If `--bookmarks` is set, wraps the _caption number_ in a bookmark:
  - tables: `tbl1`, `tbl2`, …
  - figures: `fig1`, `fig2`, …
