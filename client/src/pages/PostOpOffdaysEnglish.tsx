...
export default function PostOpOffdaysEnglish() {
  ...
  return (
    <div
      className="post-op-offdays-en-root min-h-screen bg-[#eef5f7] text-[#161d1f]"
      dir="ltr"
    >
      <style>{`
        .offdays-en-paper {
      ...
      <main className="offdays-en-print-shell flex justify-center p-8">
        <article className="offdays-en-paper flex flex-col border border-[#c2c7d1] bg-white p-12 shadow-sm">
          <header className="mb-10 flex items-start justify-between border-b-2 border-[#00355f] pb-6">
            <div>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 px-3 text-[14px] leading-7">
              <p>
                ...
                ophthalmic surgical procedure and requires a mandatory period of
                medical rest to support ocular surface healing and prevent
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-2 gap-4 px-3">
              {[
                ...
                ["Physical Strain", "No heavy lifting, swimming, or exercise."],
                [
                  "Driving Restriction",
          ...
          <footer className="mt-10 flex items-end justify-between border-t border-[#c2c7d1] pt-5 text-[11px] text-[#727780]">
            <div>
