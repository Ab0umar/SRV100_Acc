...
import { AppointmentsSection } from "@/components/dashboard/appointments-activity.redesigned";
...
export default function TodayPatients() {
  ...
  return (<FullScreenLayout>
    <div
      className="selrs-page-bg -m-3 min-h-full px-3 py-4 sm:-m-4 sm:px-4 sm:py-5"
      dir="rtl"
    >
      {medicalFilePortal}
      ...
      <div className="mx-auto w-full max-w-[1440px] space-y-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-between rounded-lg border border-border/50 bg-background px-4 py-3 text-right shadow-sm transition-colors hover:bg-muted/40"
        ...
        >
          ...
          <span className="flex items-center gap-2 text-xs font-semibold text-muted-foreground">
            {isLoading ? "…" : `${total.toLocaleString("ar-EG")} مريض`}
            {totalsOpen ? (
