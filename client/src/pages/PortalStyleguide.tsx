...
const swatches: Array<{ name: string; className: string; labelAr: string }> = [
  {
    ...
    labelAr: "الأساس — كحلي SELRS",
  },
  {
    name: "--secondary / Orange",
    className: "bg-secondary text-secondary-foreground",
    labelAr: "التمييز — برتقالي",
  },
  {
    name: "--muted",
    className: "bg-muted text-muted-foreground border border-border",
    labelAr: "خلفيات خافتة",
  },
  {
    name: "--accent",
    className: "bg-accent text-accent-foreground",
    labelAr: "تأكيد تفاعلي",
  },
  {
    name: "--destructive",
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground">
        الألوان المعرّفة في{" "}
        <span className="font-mono text-xs">client/src/index.css</span>{" "}
        (Navy&nbsp;#003D82، Orange&nbsp;#FF9500) تُحمَّل كـ Tailwind semantic:
        <span className="font-mono"> primary</span> و
        <span className="font-mono"> secondary</span> وما يرافقها.
      </p>
