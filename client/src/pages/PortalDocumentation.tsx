    ...
    >
      ...
      <ul className="list-disc space-y-2 pr-5 text-sm leading-7 text-muted-foreground marker:text-primary">
        <li>
          ...
          اتباع <span className="font-mono text-xs">AGENTS.md</span> أو أوامر{" "}
          <span className="font-mono">pnpm dev / check / build</span> على جذر
          مستودع SELRS الكامل لديك.
        </li>
        <li>
          <span className="font-semibold text-foreground">
            مزامنة MSSQL وحالات الطبيب/الخدمة:
          </span>{" "}
          راجع دليل SELRS الداخلي (
        ...
        <li>
          <span className="font-semibold text-foreground">الصلاحيات:</span>{" "}
          <span className="font-mono">ProtectedRoute</span> في الواجهة وقرارات
          الدور في الخادم عبر الإجراءات المحمية.
        </li>
      </ul>
    </div>
  );
