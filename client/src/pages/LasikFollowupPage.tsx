...
import { CalendarDays, Microscope, Printer, UserRound } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background sheet-layout" dir="rtl">
      ...
      <main className="container mx-auto px-4 py-6">
        <section className="mb-6 overflow-hidden rounded-[28px] border border-slate-200/80 bg-[radial-gradient(circle_at_top_left,_rgba(249,115,22,0.16),_transparent_34%),linear-gradient(135deg,_rgba(255,255,255,0.98),_rgba(248,250,252,0.96))] p-6 shadow-sm print:hidden">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-semibold tracking-tight text-slate-950">متابعات الليزك</h2>
                <p className="max-w-3xl text-sm leading-6 text-slate-600">
                  طبقة عرض أسرع لقراءة حالة المتابعة قبل التعامل مع النموذج، مع نفس بنية المتابعة والطباعة الحالية.
                </p>
              </div>
            </div>
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/80 bg-white/80 px-4 py-3 shadow-sm">
                ...
                <div className="mt-2 text-sm font-semibold text-slate-900">{operationType || "ليزك"}</div>
              </div>
              <div className="rounded-2xl border border-white/80 bg-white/80 px-4 py-3 shadow-sm">
