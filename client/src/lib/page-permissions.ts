...
export const PAGE_PERMISSION_DEFINITIONS = [
  ...
  { id: "/kf/sheets/consultant/:kfPatientId", label: "KF — شيت استشاري", group: "وحدة KF" },
  { id: "/kf/sheets/consultant/:kfPatientId/followup", label: "KF — متابعة استشاري", group: "وحدة KF" },
  ...
  { id: "/kf/request-tests/:id", label: "KF — طلب فحوصات مريض", group: "وحدة KF" },
