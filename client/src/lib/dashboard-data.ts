...
export const workflowNavItems = [
  ...
  {
    key: "quick-entry" as const,
    label: "دخول سريع",
    icon: "user-plus",
    badge: undefined,
  },
  {
    key: "new-cases" as const,
    label: "حالات جديدة",
    icon: "file-plus",
    badge: undefined,
  },
  ...
  {
    key: "medical-reports" as const,
    label: "التقارير الطبية",
    icon: "file-text",
    badge: undefined,
  },
  {
    key: "workflow-hub" as const,
    label: "مركز سير العمل",
    icon: "workflow",
    badge: undefined,
  },
  {
    key: "patient-hub" as const,
    label: "مركز المرضى",
    icon: "users",
    badge: undefined,
  },
...
export const dataServicesNavItems = [
  ...
  {
    key: "medical-sheets" as const,
    label: "النماذج",
    icon: "clipboard-list",
    badge: undefined,
  },
  {
    key: "sheet-designer" as const,
    label: "مصمم النماذج",
    icon: "layout-grid",
    badge: undefined,
  },
  {
    key: "pentacam" as const,
    label: "بنتاكام",
    icon: "circle-dot",
    badge: undefined,
  },
  {
    key: "sheet-copies" as const,
    label: "نسخ النماذج",
    icon: "copy",
    badge: undefined,
  },
...
export const systemSettingsNavItems = [
  ...
  {
    key: "api-tools" as const,
    label: "أدوات API",
    icon: "terminal",
    badge: undefined,
  },
  {
    key: "admin-hub" as const,
    label: "مركز الإدارة",
    icon: "layout-grid",
    badge: undefined,
  },
  {
    key: "admin-patients" as const,
    label: "إدارة المرضى (Admin)",
    icon: "users",
    badge: undefined,
  },
];
...
export const otherToolsNavItems = [
  ...
  {
    key: "medications-registry" as const,
    label: "سجل الأدوية (متقدم)",
    icon: "pill",
    badge: undefined,
  },
  {
    key: "medications-tests" as const,
    label: "أدوية و فحوصات",
    icon: "flask-conical",
    badge: undefined,
  },
  {
    key: "examinations-catalog" as const,
  ...
  {
    key: "txhub" as const,
    label: "TXhub تحاليل وأشعة",
    icon: "microscope",
    badge: undefined,
  },
  {
    key: "tests" as const,
    label: "اختصار الفحوصات",
    icon: "flask-conical",
    badge: undefined,
  },
  {
    key: "tests-management" as const,
    label: "إدارة الفحوصات (Admin)",
    icon: "clipboard-list",
    badge: undefined,
  },
  {
    key: "component-showcase" as const,
    label: "عرض المكونات",
    icon: "layout-grid",
    badge: undefined,
  },
...
export const sidebarGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: "users",
    items: usersRolesNavItems,
  },
  {
    id: "data-services",
    label: "البيانات والخدمات",
    icon: "building",
    items: dataServicesNavItems,
  },
  {
    id: "system-settings",
