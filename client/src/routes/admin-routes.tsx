...
const AdminNotificationSettings = lazy(() => import("../features/admin/AdminNotificationSettings"));
  ...
  <>
      ...
      <Route
        ...
        component={() => {
          ...
          return <Redirect href={`${ROUTES.adminHub}/${(params as Record<string, string>)?.["rest*"] ?? ""}`} />;
        }}
      />
      <Route
