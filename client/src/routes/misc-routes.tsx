...
const DoctorDashboard = lazy(() => import("../features/doctor-portal/DoctorDashboard"));
...
export function MiscRoutes() {
  return (
    <>
      ...
      />
      <Route path={ROUTES.patientPortalLogin} component={() => <Redirect to="/my/login" />} />
      <Route path={ROUTES.patientPortalRoot} component={() => <Redirect to="/my/login" />} />
