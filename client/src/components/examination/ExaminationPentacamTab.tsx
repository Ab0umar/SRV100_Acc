...
export default function ExaminationPentacamTab({
  form,
}: ExaminationPentacamTabProps) {
  const {
    handleSelectPatient,
    hasPatient,
    isMobileViewport,
    ...
    <TabsContent value="pentacam" className="sheet-layout exam-compact-inputs">
      ...
      {hasPatient && (
        <div className="bg-background p-3 sm:p-4">
            ...
            <div className="w-full px-4 space-y-3" dir="ltr">
              <Card className="border">
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="grid grid-cols-[60px_1fr] items-center gap-2">
                    <Label className="text-xs">Thinnest Point</Label>
                    <Input
                  ...
                  <div className="grid grid-cols-[60px_1fr] items-center gap-2">
                    <Label className="text-xs">Corneal Apex</Label>
                    <Input
                  ...
                  <div className="grid grid-cols-[60px_1fr] items-center gap-2">
                    <Label className="text-xs">Residual Stroma</Label>
                    <Input
                  ...
                  <div className="grid grid-cols-[60px_1fr] items-center gap-2">
                    <Label className="text-xs">Planned TTT</Label>
                    <Input
                  ...
                  <div className="grid grid-cols-[60px_1fr] items-center gap-2">
                    <Label className="text-xs">Ablation</Label>
                    <Input
          ...
          {!isMobileViewport && (
            <div
              className="max-w-4xl mx-auto mt-2 overflow-x-auto grid grid-cols-2 gap-4"
              dir="ltr"
            >
              {/* RT (Right Eye) */}
              <div className="border rounded-lg overflow-hidden">
                <div className="bg-primary text-primary-foreground font-bold p-2 text-center">
                  RT فحص القرنية
                </div>
                      ...
                      <td className="border p-2" rowSpan={2}>
                        <div className="flex flex-col h-full">
                          <Input
                            ...
                            className="h-7 w-full text-sm text-center border-input rounded-b-none"
                          />
                          ...
                          <Input
                            ...
                            className="h-7 w-full text-sm text-center border-input rounded-t-none"
                          />
                        </div>
                      </td>
                    </tr>
