    ...
    <Card className="overflow-hidden border-amber-300/80 bg-gradient-to-br from-amber-50 via-white to-orange-50 shadow-sm">
      <CardHeader className="pb-3">
        <div className="flex items-start gap-3">
          <div className="rounded-2xl border border-amber-200 bg-background/80 p-2 text-amber-700 shadow-sm">
      ...
      <CardContent className="flex flex-col gap-3 text-sm text-amber-900 sm:flex-row sm:items-center sm:justify-between">
        ...
        {onRetry ? (
          <Button type="button" variant="outline" size="sm" onClick={onRetry} className="gap-2 border-amber-300 bg-background/80 hover:bg-background">
