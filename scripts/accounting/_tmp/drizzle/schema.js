...
exports.doctorsLookup =
  exports.visitScheduleRequests =
  exports.followupItems =
  exports.followupSheets =
  exports.operationListItems =
  exports.operationLists =
  exports.sheetEntries =
  exports.userPermissions =
  exports.systemSettings =
  exports.testRequestItems =
  exports.testRequests =
  exports.testFavorites =
  exports.tests =
  exports.medications =
  exports.auditLogs =
  exports.auditLog =
  exports.medicalHistoryChecklist =
  exports.consentForms =
  exports.postOpFollowups =
  exports.surgeries =
  exports.patientServiceEntries =
  exports.patientPageStates =
  exports.pushDeviceRegistrations =
  exports.userPageStates =
  exports.diseases =
  exports.prescriptionItems =
  exports.prescriptions =
  exports.doctorReports =
  exports.pentacamResults =
  exports.glassesRecords =
  exports.afterRefractionData =
  exports.autorefractometryData =
  exports.examinations =
  exports.visits =
  exports.appointments =
  exports.patientImportStaging =
  exports.patients =
  exports.users =
    void 0;
...
exports.users = (0, mysql_core_1.mysqlTable)("users", {
  ...
  username: (0, mysql_core_1.varchar)("username", { length: 64 })
    .notNull()
    .unique(),
  ...
  role: (0, mysql_core_1.mysqlEnum)("role", [
    ...
    .default("reception")
    .notNull(),
  branch: (0, mysql_core_1.mysqlEnum)("branch", [
    "examinations",
    "surgery",
    "both",
  ])
...
exports.patients = (0, mysql_core_1.mysqlTable)("patients", {
  ...
  branch: (0, mysql_core_1.mysqlEnum)("branch", [
    "examinations",
    "surgery",
  ]).default("examinations"), // ط§ظ„ظپط±ط¹ ط§ظ„ط£ط³ط§ط³ظٹ
  serviceType: (0, mysql_core_1.mysqlEnum)("serviceType", [
    "consultant",
    "specialist",
    "lasik",
    "surgery",
  ...
  locationType: (0, mysql_core_1.mysqlEnum)("locationType", [
    "center",
    "external",
  ]).default("center"), // مكان الخدمة
  ...
  receptionSignature: (0, mysql_core_1.varchar)("receptionSignature", {
    length: 255,
  }), // توقيع الاستقبال الأخير
  status: (0, mysql_core_1.mysqlEnum)("status", [
    "new",
    "followup",
    "archived",
  ]).default("new"), // ط­ط§ظ„ط© ط§ظ„ظ…ط±ظٹط¶
  createdAt: (0, mysql_core_1.timestamp)("createdAt").defaultNow().notNull(),
  updatedAt: (0, mysql_core_1.timestamp)("updatedAt")
    .defaultNow()
    .onUpdateNow()
...
exports.patientImportStaging = (0, mysql_core_1.mysqlTable)(
...
exports.appointments = (0, mysql_core_1.mysqlTable)("appointments", {
  ...
  appointmentType: (0, mysql_core_1.mysqlEnum)("appointmentType", [
    "examination",
    "surgery",
    "followup",
...
exports.visits = (0, mysql_core_1.mysqlTable)("visits", {
  ...
  receptionSignature: (0, mysql_core_1.varchar)("receptionSignature", {
    length: 255,
  }), // توقيع الاستقبال / ENTEREDBY
  queueStatus: (0, mysql_core_1.mysqlEnum)("queueStatus", [
    "checkedIn",
    "next",
    "clinic",
    "treated",
 ...
 */
exports.autorefractometryData = (0, mysql_core_1.mysqlTable)(
  "autorefractometryData",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    examinationId: (0, mysql_core_1.int)("examinationId")
      .notNull()
      .references(() => exports.examinations.id, { onDelete: "cascade" }),
    patientId: (0, mysql_core_1.int)("patientId").notNull(),
    // Right Eye (OD)
 ...
 */
exports.afterRefractionData = (0, mysql_core_1.mysqlTable)(
  "afterRefractionData",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    examinationId: (0, mysql_core_1.int)("examinationId")
...
exports.prescriptions = (0, mysql_core_1.mysqlTable)("prescriptions", {
  ...
  patientId: (0, mysql_core_1.int)("patientId").notNull(),
  doctorId: (0, mysql_core_1.int)("doctorId"), // ط§ظ„ط·ط¨ظٹط¨
  prescriptionDate: (0, mysql_core_1.timestamp)("prescriptionDate")
    .defaultNow()
    .notNull(),
  notes: (0, mysql_core_1.text)("notes"),
  createdAt: (0, mysql_core_1.timestamp)("createdAt").defaultNow().notNull(),
...
exports.pushDeviceRegistrations = (0, mysql_core_1.mysqlTable)(
  "push_device_registrations",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    userId: (0, mysql_core_1.int)("userId").notNull(),
    provider: (0, mysql_core_1.mysqlEnum)("provider", ["fcm"])
      .default("fcm")
      .notNull(),
    ...
    lastSeenAt: (0, mysql_core_1.timestamp)("lastSeenAt")
      .defaultNow()
      .notNull(),
  ...
  (table) => ({
    tokenUniqueIdx: (0, mysql_core_2.uniqueIndex)(
      "ux_push_device_registrations_token",
    ).on(table.token),
    userDeviceIdx: (0, mysql_core_1.index)("idx_push_device_user_device").on(
      table.userId,
      table.deviceId,
    ),
    activeByUserIdx: (0, mysql_core_1.index)("idx_push_device_active_user").on(
      table.userId,
      table.disabledAt,
      table.lastSeenAt,
    ),
 ...
 */
exports.patientPageStates = (0, mysql_core_1.mysqlTable)(
  "patientPageStates",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    patientId: (0, mysql_core_1.int)("patientId").notNull(),
  ...
  (table) => ({
    patientPageIdx: (0, mysql_core_1.index)("idx_patient_page_updated").on(
      table.patientId,
      table.page,
      table.updatedAt,
    ),
 ...
 */
exports.patientServiceEntries = (0, mysql_core_1.mysqlTable)(
  "patientServiceEntries",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    patientId: (0, mysql_core_1.int)("patientId").notNull(),
    serviceCode: (0, mysql_core_1.varchar)("serviceCode", {
      length: 64,
    }).notNull(),
    serviceName: (0, mysql_core_1.varchar)("serviceName", { length: 255 }),
    source: (0, mysql_core_1.mysqlEnum)("source", ["mssql", "manual", "import"])
      .default("mssql")
      .notNull(),
    sourceRef: (0, mysql_core_1.varchar)("sourceRef", { length: 128 })
      .notNull()
      .unique(),
  ...
  (table) => ({
    patientServiceDateIdx: (0, mysql_core_1.index)(
      "idx_patient_service_date",
    ).on(table.patientId, table.serviceCode, table.serviceDate),
    sourceUpdatedIdx: (0, mysql_core_1.index)("idx_service_source_updated").on(
      table.source,
      table.updatedAt,
    ),
  }),
 ...
 */
exports.medicalHistoryChecklist = (0, mysql_core_1.mysqlTable)(
...
exports.medications = (0, mysql_core_1.mysqlTable)("medications", {
  ...
  activeIngredient: (0, mysql_core_1.varchar)("activeIngredient", {
    length: 255,
  }),
  ...
  inventoryStatus: (0, mysql_core_1.mysqlEnum)("inventoryStatus", [
    "available",
    "out_of_stock",
    "reserved",
  ]),
...
exports.testRequests = (0, mysql_core_1.mysqlTable)("testRequests", {
  ...
  patientId: (0, mysql_core_1.int)("patientId").notNull(),
  visitId: (0, mysql_core_1.int)("visitId"),
  requestDate: (0, mysql_core_1.timestamp)("requestDate")
    .defaultNow()
    .notNull(),
  status: (0, mysql_core_1.mysqlEnum)("status", [
    "pending",
 ...
 */
exports.userPermissions = (0, mysql_core_1.mysqlTable)(
  "user_permissions",
  {
    userId: (0, mysql_core_1.int)("userId").notNull(),
...
exports.sheetEntries = (0, mysql_core_1.mysqlTable)("sheet_entries", {
  id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
  patientId: (0, mysql_core_1.int)("patientId").notNull(),
  sheetType: (0, mysql_core_1.mysqlEnum)("sheetType", [
    "consultant",
    "specialist",
    "lasik",
    "external",
 ...
 */
exports.operationListItems = (0, mysql_core_1.mysqlTable)(
  "operationListItems",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
  ...
  (table) => ({
    listNumberIdx: (0, mysql_core_1.index)("idx_operation_list_number").on(
      table.listId,
      table.number,
    ),
  }),
 ...
 */
exports.followupSheets = (0, mysql_core_1.mysqlTable)(
  "followupSheets",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    patientId: (0, mysql_core_1.int)("patientId").notNull(),
  ...
  (table) => ({
    patientSheetTypeIdx: (0, mysql_core_1.index)(
      "idx_followup_patient_type",
    ).on(table.patientId, table.sheetType),
  }),
);
/**
 * Followup Items table - بيانات كل جدول متابعة (4 جداول في كل شيت)
 */
exports.followupItems = (0, mysql_core_1.mysqlTable)(
  "followupItems",
  {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
  ...
  (table) => ({
    sheetTableIdx: (0, mysql_core_1.index)("idx_followup_sheet_table").on(
 ...
 */
exports.visitScheduleRequests = (0, mysql_core_1.mysqlTable)(
  ...
  (table) => ({
    visitDateIdx: (0, mysql_core_1.index)(
      "idx_visit_schedule_requests_visitDate",
    ).on(table.visitDate),
  }),
);
/**
