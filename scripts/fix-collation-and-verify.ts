...
async function main() {
  ...
  try {
    console.log("Fixing collation and verifying...\n");

    // Fix collation of mapping table
    await conn.query(`
      ALTER TABLE patient_id_mapping_correct
