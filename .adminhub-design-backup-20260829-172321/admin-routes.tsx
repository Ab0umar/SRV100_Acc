...
export const AdminRoutes = (
  <>
    {/* Admin routes */}
    {/* Legacy admin hub URLs redirect to the canonical /admin-hub path. */}
    <Route
    ...
    <Route
      ...
      component={() => {
        const [, params] = useRoute(ROUTES.legacyAdminHubRestWildcard);
        return (
          <Redirect
    ...
    <Route
      ...
      component={() => (
        <ProtectedRoute requiredRoles={["admin"]} hideAppShell>
          <AdminHubShell />
        </ProtectedRoute>
      )}
    />
